...
abstract class StaffCustomersRemoteDataSource {
  ...
  Future<UserModel> getCustomerById({
...
class StaffCustomersRemoteDataSourceImpl implements StaffCustomersRemoteDataSource {
  ...
  Future<List<UserModel>> getCustomers({
    ...
    try {
      ...
      throw ServerException(
        message: e.response?.data?['message'] as String? ?? 'Không thể tải danh sách khách hàng',
  ...
  Future<UserModel> getCustomerById({
    ...
    try {
      ...
      if (e.error is NetworkException) throw e.error!;
      throw ServerException(
        message: e.response?.data?['message'] as String? ?? 'Không thể tải chi tiết khách hàng',
        statusCode: e.response?.statusCode,
      );
    } catch (e) {
      throw ServerException(message: e.toString());
  ...
  Future<List<OrderModel>> getCustomerOrders({
    ...
    try {
      ...
      if (e.error is NetworkException) throw e.error!;
      throw ServerException(
        message: e.response?.data?['message'] as String? ?? 'Không thể tải lịch sử mua hàng',
        statusCode: e.response?.statusCode,
      );
    } catch (e) {
      throw ServerException(message: e.toString());
