...
export default function ManagerLayout() {
    ...
    const navItems = [
        { path: '/manager/dashboard', label: 'Tổng quan', icon: BarChart3, exact: true },
                    ...
                    >
                        ...
                        {isHovered && (
                            <div className="flex flex-col overflow-hidden whitespace-nowrap animate-in fade-in duration-300">
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-wider text-orange-600/80 mt-1">Manager Portal</span>
                            </div>
                        )}
                    </Link>
                    <button
                    ...
                    <div className={`flex items-center p-3 bg-slate-50 border border-slate-200/60 rounded-xl mb-3 transition-all duration-300 ${isHovered ? 'gap-3' : 'justify-center p-2'}`}>
                        ...
                        {isHovered && (
                            <div className="flex flex-col overflow-hidden whitespace-nowrap animate-in fade-in duration-300 text-left">
                                <span className="text-xs font-black text-slate-800">Quản lý cửa hàng</span>
